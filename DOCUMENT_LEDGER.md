...
| `DOCUMENT_LEDGER.md` | VIEW | (declared in frontmatter) | c54.205 | c54.205 | 1 |
| `ID_SPACE_CENSUS.md` | VIEW | (declared in frontmatter) | c54.205 | c54.205 | 1 |
| `INDEX.md` | VIEW | The corpus index — restored r2427 after the duplicate sweep deleted it at r2385/r2393 (a 49 KB live document removed because a 32 KB stub shared its name in retired/). | — | c54.205 | 1 |
...
| `BOARD.md` | STATE | (declared in frontmatter) | — | c54.205 | 1 |
...
| `CORPUS_MAP.md` | STATE | (declared in frontmatter) | — | c54.205 | 1 |
...
| `OPEN_PROBLEMS_MAP.md` | STATE | The work-CLUSTERS, the readiness/priority sort and the runway — a VIEW of the lead register since c54.90, never a second source of truth for what is open | — | c54.205 | 1 |
