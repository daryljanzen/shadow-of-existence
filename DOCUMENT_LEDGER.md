...
# THE DOCUMENT LEDGER
*Generated by `scripts/classify_documents.py` at fork front **c54.233**. **Do not hand-edit** — declare `kind:` in a file's own frontmatter, or add it to the tables in the script.*
...
| `CATEGORY_THEORY_LEDGER.md` | REFERENCE | category theory against CR — the corpus's largest unlisted field | — | c54.185 |  |
