...
| **`L-171`** | OPEN | RESTATED c54.127 — MY c54.126 FRAMING WAS WRONG AND OVERSTATED, AND IT WAS WRONG IN THE WAY THIS FRONT IS DOCUMENTED TO GO WRONG. I registered it as '1.15 computed against 2.21 measured — the sharpest empirical discrepancy in the corpus'. It is not a disagreem… | P15 `sec:flatlcdm`; receipt `ROBUST_p1p2_scan`; `PO-7` | content superseded r2481 — the perturbation route produces no definite $\ell_1$, so there is no internal disagreement left to work · what remains is `… |
