...
print("    - the 8/9 coefficient against the 16/15 polarization-corrected one -- ** CLOSED at")
print("      r2376+c54.177: the polarised photon hierarchy DERIVES 16/15 and the unpolarised")
print("      one 8/9, their ratio landing on 6/5 to three parts in ten thousand. ** This")
print("      derivation is unaffected: the coefficient nearly cancels in a RATIO of two")
print("      rates, and +10.83% becomes +10.87%.  `P15_the_shear_coefficient_derived_not_remembered`")
print("="*80)
