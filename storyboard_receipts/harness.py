...
os.environ['ESTORE']='0.5'; os.environ['STRIDE']='1'; os.environ['ETAEND']='460'; os.environ['SNAPETA']='170'
...
for i,k in enumerate(kk):
    ...
    s=solve_ivp(rhs,[e0,420.],Y0[i],method='Radau',rtol=1e-4,atol=1e-9,dense_output=True)
