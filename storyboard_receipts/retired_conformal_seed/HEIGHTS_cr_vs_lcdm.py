...
print(f"\n  *** CR PEAK HEIGHTS (A_s-free ratios) ***")
print(f"    peaks at l = {[p[0] for p in pk]}")
if len(pk)>=3:
    print(f"    P1/P2 = {pk[0][1]/pk[1][1]:.3f}")
    print(f"    P1/P3 = {pk[0][1]/pk[2][1]:.3f}")
    print(f"    P2/P3 = {pk[1][1]/pk[2][1]:.3f}")
print(f"\n  LambdaCDM control (r1975/r2002): peaks 225/510/810, P1/P2=2.299")
print(f"  measured sky:                    peaks 220/536/813, P1/P2=2.212, P1/P3=2.257")
