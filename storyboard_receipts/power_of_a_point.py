"""
c40's POWER-OF-A-POINT finding, verified — and pushed. (r1104)

c40 (still live) found, working the pin that had been bugging Daryl:
  * the pin at 36.87 deg is NOT the turnaround (28.81 deg): the pin is RATIONAL
    ((4/5, 3/5), from 5t^2 - 8t + 3 = 0), the turnaround IRRATIONAL (a cube root).
    They cannot coincide.
  * dist(hinge -> pin) x dist(hinge -> pole) = 1.341641 x 2.236068 = 3.000000
  * and the POWER of the hinge w.r.t. the hole is |A|^2 - alpha^2 = 4 - 1 = 3.
  => "the hinge's power is 3, fixed, and every sightline through the hole obeys it."

Daryl's own words for what he was reaching for: the conjugation looked like "the ratio
of the subtended line segments" rather than a loop round the equator. c40 says: it is
the power of a point.

VERIFY IT. THEN ASK THE ONE QUESTION c40 DID NOT: **why 3?**
"""
import numpy as np
