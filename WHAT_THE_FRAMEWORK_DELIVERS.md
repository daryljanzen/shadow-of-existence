...
- ⛭⛭⛭ **THE DIRAC CONSTRAINT ALGEBRA IS THE SUBSTRATE'S SYMMETRIC-SPACE GRADING, TERM FOR TERM.**
  ...
  **is the hypersurface-deformation bracket**.*
  ...
  - ⛔ ***Scope, from `P07` itself***: *this is established on the **symmetry-reducible sector —
    finite-dimensional $\mathfrak{so}(5,1)$, not the full infinite-dimensional Dirac algebra** — and the
    covariance-of-geometries reading is what the theorems **ground**, not a corollary they entail.*
