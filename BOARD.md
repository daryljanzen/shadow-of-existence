...
>
> *8 live rows: **4 veins**, **3 leads**. 266 struck.*
...
| **2** | **`L-207`** | `L-165` | 1/3 | 3/3 | ⓶ the confined/branch-point exhibition — **gated on PO-6 and must not be opened without it** (⓵ discharged r2450) |
| **3** | **`L-218`** | *— instrument work* | 3/3 | 0/3 | ✔ ⓶ done r2478 (`COMPANION_SPEC`) · ⓵ the reader-package formats via pandoc in CI · ⓷ the contribution, last |
...
- **`L-805`** — ***is this a vein, a lead, or done? Decide or strike it.***
