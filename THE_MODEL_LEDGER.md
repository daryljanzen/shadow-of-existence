...
| **`NOSLIP`** | the baryon-photon slip damping in the photon momentum equation | **DETERMINED — off (i.e. slip ON)** | *ordinary tight-coupling physics on the layer; belongs. **Wired r3090 only to test it, and it is eliminated: peaks byte-identical, $P_1/P_2$ $1.447\to1.442$.*** | *r3090* |
