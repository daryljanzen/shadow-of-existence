...
| **`MAT`** | matter fraction's denominator | ⚠ **OPEN — currently `1`** | *the fractions are $\rho_i/\rho_{\rm tot}$, and **which total** depends on what the $(3H_c^2/2)\Omega$ conversion is allowed to assume. **This is the site of the $r_t$-vs-$r_H$ inconsistency** (r3041).* | *unresolved: the rate excludes radiation, the denominator includes it* |
