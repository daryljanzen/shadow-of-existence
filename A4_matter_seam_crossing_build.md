...
**The genuine remaining open piece** (not manufactured): the matter *dynamics* — the actual propagation of material worldlines/fields through the seam for a given matter model — is what P7 defers, and what 3b's regularity shows to be **well-posed** (finite-curvature characteristic crossing), matching P7 §658 ("the Null–Boundary Correspondence … fixes the cosmological beginning at the branch point at $r=0$ (well-posed because $r_*$ CONVERGES, **not** because curvature is finite -- it diverges there; r2234) $r=0$, which makes the early-universe sector well posed"). The well-posedness is established; the detailed worldline dynamics is the deferred depth — and it is *dynamics*, never a value.
