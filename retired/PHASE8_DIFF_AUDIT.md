> **⌗ RETIRED r2380 under `RG-1` — THE AUDIT RAN TO COMPLETION AND SAID SO.**
> *Opened r1874 after Phase 8's four field bakes — quadric, conformal, optics, complex analysis — **were found
> to have been run without holding the substrate and slicing apparatus**, by grepping fragments rather than
> reading the construction.* ***It is marked COMPLETE at r1880: 19 claims and 8 non-claim changes, all ruled at
> source against the apparatus, 49 KEPT/DROPPED verdicts recorded.***
>
> **⌗ WHY IT IS A RECORD AND NOT A LOSS, in its own words:** *"**the work is genuinely rich and much of it is
> right, so the operation is not a revert: it is a filtered revert.**" What survived is in the four field
> ledgers; what failed was dropped with its reason; and its own note that* ***"the corrections themselves may
> carry new results"*** *is the disposition that makes a filtered revert worth more than either a revert or a
> keep.*
>
> **⌗ AND ITS LESSON IS STANDING DISCIPLINE, which is why the audit does not need to stay live.** *"Run without
> holding the apparatus" became `THE_PLAN`'s **GREP TO FIND, READ TO CONFIRM** (r1874, the four confirmations —
> ontology, section, apparatus, computation) and its full form is cited back to this file's §4. **The rule
> outlived the audit, which is the correct order.***
