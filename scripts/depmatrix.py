...
labels={'P1':'P1 \; wedge','P2':'P2 \; circle','P3':'P3 \; slicing','P4':'P4 \; mod.\\ parallax','P5':'P5 \; groupoid','P6':'P6 \; shadow','P7':'\\textbf{P7 \; framework}','P8':'P8 \; operator','P9':'P9 \; range','P10':'P10 \; canon.\\ time','P11':'P11 \; dynamics','P12':'P12 \; algebroid','P13':'P13 \; boundary','P14':'P14 \; matter','P15':'P15 \; cosmology','P16':'P16 \; cosmogenesis','P17':'\\textbf{P17 \; core}','P18':'P18 \; synthesis'}
