...
RECORD_EXACT = {'BOARD.md', 'WHATS_TEED_UP.md', 'THE_BURN_DOWN.md', 'ID_SPACE_CENSUS.md',
                ...
                # ** r3593: the ledger-citation campaign's record, beside its r1201 sibling.
...
STATE = {
    ...
    'retired/CORPUS_REVISION_OWED.md':                        'the measured gap between the register and the papers',
