...
EST = {
    ...
    'PO-45': ('the colourless triple has no seat, and the reason is the dimension result', 1, 0, 3, None,
        ...
        'answer rests on it. WHERE THE ROW STANDS: four clauses run -- colour trivial, '
        'isospin a single character missing the doublet, chirality 3+0 and untouched, and '
        'the doublets two values not in the causal stratification at all. A locus carrying '
        'the pair must supply a two-valued datum INDEPENDENT of R, and P07s five spans and '
        'four joints supply none. '
),
