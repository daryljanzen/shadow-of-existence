...
EST = {
    ...
    'PO-45': ('the colourless triple has no seat, and the reason is the dimension result', 1, 0, 3, None,
        ...
        'involution IS R. SO THE DEMAND ON A SUCCESSOR IS ONE THING, NOT THREE: not find a '
        'doublet but FIND A LOCUS WHOSE MODES SPAN BOTH R-EIGENVALUES. Two T-values inside one '
        ...
        'triple: they are the generations, already spoken for. Nothing named, nothing '
        'seated, chirality and L8s verdict untouched. '
),
