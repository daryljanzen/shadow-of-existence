...
| **PO-1b** | the SIGN 2+1 | **1** | 1 | 1 | READ | — | CLEAR -- sign(r) IS species and the parity link is established; one type-check to finish |
| **PO-1a** | the DESIGNATION 2+1 | **2** | 2 | 4 ⚠ | BUILD | — | CLEAR but unsourced -- nothing derives the flavour indexical from the geometry |
