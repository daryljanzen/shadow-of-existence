...
""")
print("="*70)
print("THE BOUNDARY P10 SETS (not claimed, honored): P10 lists THREE DISTINCT discrete")
...
print("is P10's explicit not claimed AND the face-19 flavor-match spot (fusing distinct")
