...
| 4 | order-3 bridge (scope corrected r1430) | groupoid Z/3 (r^3-r+2M) vs bead Z/3 (r^3+2M) = DIFFERENT cubics; no AFFINE change of variable identifies their root sets (obstruction at fixed cubic; the two are the E=1 and E=0 ends of one turning-point family, stage 5); identification of root sets do-not-assert | YES (bounded negative + stage-5 family with control) | `order3_bridge.py` | ✔✔ |
