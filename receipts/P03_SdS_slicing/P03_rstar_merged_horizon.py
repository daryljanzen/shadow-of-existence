"""
P03_rstar_merged_horizon.py -- the Hubble-Eddington radius r_star = (M alpha^2)^(1/3) lies ON a
horizon for EXACTLY ONE member of the SdS family, the double-root (Nariai) member, and there it IS
the merged horizon rho = alpha/sqrt3. MECHANISM (not a number-match): K_G = 0 is M/r^3 = 1/alpha^2,
which absorbs the mass from the potential and leaves f = 1 - 3r^2/alpha^2, the pure de Sitter form at
