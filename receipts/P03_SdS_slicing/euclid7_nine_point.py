# ── AVENUE 11 VERIFICATION HEADER (r1338, Arthur) ──────────────────────────────
# VERIFIES: the nine-point circle of the hinge triangle (vertices at R=2α) IS the throat — centre O,
#   radius R/2=α, all nine points on |X|=α; a sixth independent characterisation of 2α using only Euler's
#   R/2 (no tangent/power/sine/inversion). Nine points collapse to six at 60° (tangencies + Euler points);
#   Feuerbach degenerates (nine-point = incircle). [P3 SdS-slicing-curve_v2 §488, prop nine-point item]
# STATUS: ✔✔  (nine points computed explicitly; FALSIFIER sweep |hinge|∈{1,1.5,2,2.5,3} rejects all but 2α;
#   self-corrects a prior excentre-distance error)
# BOUND: the "third scale" excircle question (radius 3a, centres 4a) named well-posed, not pursued. RUN: python3 euclid7_nine_point.py
# ORIGIN: storyboard_receipts/euclid7_nine_point.py (r1110), verified + canonicalized r1338.
# ───────────────────────────────────────────────────────────────────────────────
"""
