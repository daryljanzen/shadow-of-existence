"""
P13_ruling_swaps.py -- verifies prop:closure(iii) -- R swaps the substrate's two null rulings (generic: every orientation-reversing isometry does). [P13 boundary_paper]
STATUS: ✔✔   ORIGIN: storyboard_receipts/ruling_swaps.py, verified r1380.
