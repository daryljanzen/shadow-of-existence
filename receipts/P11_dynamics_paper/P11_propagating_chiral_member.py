...
for s in [
 ...
 "   solution, and the chirality is exhibited ON it. **",
    "",
    "⚠ ** WHAT THIS IS NOT: THE FIFTH CLASS. **  *The multiplet shortfall is a MATTER-sector\n     count, and nothing here computes one -- no spinor, no wall kernel, no triality, no grading.\n     What is removed is the CAUSE P14 identified: the grading could not act on one chirality\n     eigenspace and not the other because the built geometry was the achiral member. That member\n     is no longer the only one built. Whether the grading descends onto the chiral member and\n     separates the right-handed pair is the next computation, and it is P14's, not this one's.*",
 "",
