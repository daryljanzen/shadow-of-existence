#!/usr/bin/env python3
"""
P14_L8_the_twelve.py -- verifies THE 12 (sec:family): the twelve designations (every 30 deg on the dial) =
  |Aut(A_2)|=|D_6|=12, FORCED by the dihedral structure (not arithmetic luck): the 12 marks are the
  fixed-point set of D_6's 6 reflections (axes meet the dial in 12 points), and split as two 6-orbits
  (generic orbit 12, Nariai w=30 stabilised to 6): 6+6=12. The two factorisations are the same object.
  [P14 matter_sector_paper sec:family]
STATUS: ✔✔   ORIGIN: storyboard_receipts/L8_the_twelve.py, verified r1385.
