...
r2803  CLAIMED    PO-2: does level (3)s not claimed still guard anything, now P14 exhibits the map?
...
r3068  LATENT      projection eliminated (N=1 for the comoving congruence). Audit complete; defect remains. Left: budget conversion, imposed scale.
r3069  LATENT      precondition 6 eliminated: T_onset = 1.6 eV gives z = 6811 vs the solved 6761. One candidate left: the budget conversion.
...
r3082  CORPUS      OWED #584: P10 disclaims what P7 develops; must cite it. Data claims: BAO DESI DR2 chi2/dof~1, D and He-4 within 1 sigma.
r3083  LATENT      the seam is a morphism between two readings of one layer; phase is causal-structure-dependent, amplitude is not.
...
r3090  LATENT      RHS read whole; slip term sized, tested, eliminated (byte-identical peaks). Sound speed verified.
r3091  LATENT      damping sector sound: closure split correct, 16/45 verified to ratio 1.000000. My dead code removed.
r3092  LATENT      the phase reset assumes an unbounded tortoise phase; r2154 (1) derived it FINITE. PHZ wired and live.
