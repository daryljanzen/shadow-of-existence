...
subtraction}: removing every coupling to the potential moves the control's first peak from $220$ to $276$,
which is the size of the driving on the arm whose answer is known.
