...
\textbf{P7 \; framework} & \textbf{34} & \textbf{15} & \textbf{25} & \textbf{18} & \textbf{23} & \textbf{15} & -- & \textbf{15} & \textbf{11} & \textbf{19} & \textbf{12} & \textbf{13} & \textbf{20} & \textbf{27} & \textbf{33} & \textbf{12} & \textbf{14}\\
P8 \; operator & 2 & 6 & 8 & 2 & 2 & 5 & 17 & -- & 5 & 3 & 2 & 2 & . & 2 & 3 & 4 & 4\\
...
P13 \; boundary & 1 & 1 & 8 & 1 & 5 & 2 & 13 & 5 & 6 & 6 & 5 & 15 & -- & 30 & 3 & 3 & 9\\
P14 \; matter & . & 3 & 16 & . & 4 & 3 & 10 & 3 & 1 & 2 & 3 & 9 & 23 & -- & 1 & 2 & 9\\
P15 \; cosmology & 4 & 3 & 8 & 8 & 3 & 4 & 20 & 13 & 4 & 4 & 3 & 1 & . & 3 & -- & 17 & 4\\
...
configuration --- reproducing a standard code's first-to-second height ratio to $0.18\%$ at peaks $220$,
$540$ and $812$ --- and on that configuration this construction's arm returns
$\ell_{1}/\ell_{A}=0.6764$ against the sky's $0.7312$, with height ratios $1.759$ and $1.612$ against
...
arms}: removing it moves this arm's first peak by $136$ multipoles against the control's $56$, so the
arm is driven $2.4$ times as hard as the control and \emph{overshoots} rather than falling short.
\emph{What remains of this item is accordingly two things, and neither of them is the transfer}: the
full-spectrum likelihood comparison, which has not been run, and a mechanism for a deficit that is now
measured.  The exact large-angle shape is now computed on a genuine Boltzmann transfer---a mild, non-discriminating low-multipole deficit consistent with the standard model within cosmic variance.
