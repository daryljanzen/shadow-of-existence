...
A further quantity vanishes with it, and it is worth recording because it is the optical face of the same degeneracy. The circular null orbit of the family sits at $r=3M$---the photon sphere, obtained from $\dd(f/r^{2})/\dd r=0$ and independent of $\alpha$---and at the Nariai value $M=\alpha/3\sqrt3$ that radius is $\alpha/\sqrt3$, the merged root itself. Both the surface gravity $\kappa=f'(r_{h})/2$ and the photon orbit's Lyapunov exponent $\lambda$~\cite{Cardoso2009}, whose square carries an overall factor $f(r_{\rm ph})$, therefore vanish there\rcpt{O5_kappa_and_lyapunov}\ldg{optics_lensing}---by different routes, $\kappa$ because the root is double and $\lambda$ because the orbit lies on the horizon, and both only because $3M=r_{h}$, which is the Nariai condition.
...
\hline
\textsf{algebraic geometry} & . & . & . & . & . & . & . & . & . & . & . & . & . & . & . & . & .\\
\textsf{cartan holonomy} & . & . & . & . & . & . & . & . & . & . & . & 1 & . & 2 & . & . & .\\
\textsf{catastrophe singularity} & . & . & . & . & . & . & . & . & . & . & . & . & . & . & . & . & .\\
\textsf{category theory} & . & . & . & . & 1 & . & . & . & . & . & . & 1 & . & . & . & . & 1\\
\textsf{combinatorics} & . & . & 1 & . & . & . & 2 & . & . & . & . & . & . & 1 & . & . & 1\\
\textsf{complex analysis} & . & 1 & . & . & 1 & . & . & . & . & . & . & 1 & . & . & . & 1 & .\\
\textsf{conformal geometry} & . & . & 1 & . & . & . & . & . & . & . & . & . & . & 1 & . & . & 1\\
\textsf{convexity optimisation} & . & . & . & . & . & . & . & . & . & . & . & . & . & . & . & . & .\\
\textsf{functional analysis} & 1 & . & . & . & . & . & . & . & . & 1 & . & . & . & . & . & . & .\\
\textsf{harmonic analysis} & . & . & 1 & 1 & . & . & . & . & . & . & . & . & . & . & . & . & .\\
\textsf{involution real forms} & . & . & . & . & . & . & . & . & . & . & . & . & 2 & . & . & . & .\\
\textsf{optics lensing} & . & . & . & . & . & . & 2 & . & . & . & . & . & . & . & 1 & . & .\\
\textsf{quadric geometry} & . & . & 1 & . & 1 & . & . & . & . & 1 & . & . & . & . & . & . & 2\\
\textsf{representation theory} & . & . & 2 & . & . & . & . & . & . & . & . & . & . & 1 & . & . & .\\
\textsf{spectral theory} & . & . & 1 & . & . & . & . & . & 1 & . & . & . & . & 2 & . & . & .\\
\textsf{statistics inference} & . & . & . & 1 & . & . & . & . & . & . & . & . & . & . & . & . & .\\
\textsf{variational} & . & . & . & . & . & . & . & . & 1 & 1 & . & . & . & . & . & . & .\\
\textsf{figure theorem} & . & . & . & . & . & . & 1 & . & . & . & . & . & . & . & . & . & 3\\
\end{tabular}}
