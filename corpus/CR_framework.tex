...
\hline
P1 \; wedge & -- & 4 & 2 & $\lozenge$2 & . & 2 & 9 & . & . & 2 & 1 & . & . & . & 2 & 2 & 2\\
...
\textbf{p0 \; core} & \textbf{2} & \textbf{2} & \textbf{22} & \textbf{7} & \textbf{8} & \textbf{4} & \textbf{14} & \textbf{6} & \textbf{5} & \textbf{6} & \textbf{3} & \textbf{12} & \textbf{19} & \textbf{14} & \textbf{10} & \textbf{2} & --\\
\end{tabular}%
}
