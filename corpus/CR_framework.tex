...
missing multiplet and the missing polarisation are no longer the same absence}: the chiral member
exists, and what remains is the descent of the matter sector's grading onto it---a step within the
matter sector rather than a geometry still to be constructed.
