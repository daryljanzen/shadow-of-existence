...
chirality-asymmetric action and does not select it}: the shortfall is not repaired by the chiral member
either, and the sector's four classes stand against the five required.  \emph{What that leaves is not a
further geometry but a different question}---whether the fifth class is delivered by the matter sector
at all, or whether the count is telling us the grading is not where the Standard Model's fifth
multiplet comes from.
