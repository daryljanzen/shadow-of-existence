...
the single combination that is its $\alpha$~\cite{JanzenAlgebroid}.  \emph{So the tower is not costly
but empty}: the cut is blind to everything above it, which is why the substrate's dimension is bounded
below and not above, and why a rung added to buy compact rank delivers that rank to the ambient
isometry and none of it to the cut.  \emph{The compact face is the other half and is capped
