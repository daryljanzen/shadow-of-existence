...
A further quantity vanishes with it, and it is worth recording because it is the optical face of the same degeneracy. The circular null orbit of the family sits at $r=3M$---the photon sphere, obtained from $\dd(f/r^{2})/\dd r=0$ and independent of $\alpha$---and at the Nariai value $M=\alpha/3\sqrt3$ that radius is $\alpha/\sqrt3$, the merged root itself. Both the surface gravity $\kappa=f'(r_{h})/2$ and the photon orbit's Lyapunov exponent $\lambda$~\cite{Cardoso2009}, whose square carries an overall factor $f(r_{\rm ph})$, therefore vanish there\rcpt{O5_kappa_and_lyapunov}---by different routes, $\kappa$ because the root is double and $\lambda$ because the orbit lies on the horizon, and both only because $3M=r_{h}$, which is the Nariai condition.
...
\emph{and the factor has a cause rather than being a coincidence}. The turnaround is the locus $1-f=0$,
...
and $\alpha$---but the quantity it ties the amplitude to is the static radius and not a horizon.\rcpt{P07_cube_root_two_is_the_2M_over_M} \emph{Two of the readings are the companion epistemic paper's and are not repeated in the list above}---the
...
\textbf{P7 \; framework} & \textbf{35} & \textbf{15} & \textbf{25} & \textbf{18} & \textbf{23} & \textbf{18} & -- & \textbf{15} & \textbf{11} & \textbf{19} & \textbf{8} & \textbf{12} & \textbf{17} & \textbf{22} & \textbf{31} & \textbf{12} & \textbf{13}\\
P8 \; operator & 2 & 6 & 8 & 1 & 2 & 4 & 15 & -- & 6 & 3 & 2 & 2 & . & 2 & 3 & 4 & 4\\
P9 \; range & . & 1 & 3 & . & 2 & 1 & 11 & 9 & -- & . & 6 & 3 & 3 & 1 & 1 & 3 & 3\\
P10 \; canon.\ time & 7 & 1 & 3 & 4 & 1 & 3 & 19 & 4 & 2 & -- & 2 & 2 & 1 & . & 1 & 2 & 8\\
...
%  REGISTER ALIAS: the interacting quantum tower -- register `PO-15` (THE ORDERING), OPEN; this item is the row's named home, with P10.
...
it was asked to mean anything---and no counting argument in this sector distinguishes them, which is
why the shortfall is a count and not a missing distinction~\cite{JanzenMatter}.  The
