...
first-to-second height ratio to $0.23\%$ at peaks $220$, $536$ and $814$ --- and on that configuration
this construction's arm returns peaks at $206$, $528$, $832$ and $1196$, $\ell_{1}/\ell_{A}=0.6830$
against the sky's $0.7312$, a $6.6\%$ deficit in position, with height ratios $1.759$ and $1.612$
against $2.217$ and $2.277$, two wavenumber cutoffs agreeing to every digit.  \emph{Neither instrument
...
arm}: over $133$ bins of Planck TT the control returns $2.10$ in $\chi^{2}$ per bin and this arm
$118.4$~\cite{JanzenCRcosmology}. \emph{The construction's acoustic spectrum is rejected on TT shape in that
configuration}, and the control's own distance from the noise floor is a factor of two where the gap is a
