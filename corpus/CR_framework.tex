...
P18 \; synthesis & 15 & 13 & 23 & 14 & 14 & 18 & 28 & 15 & 11 & 17 & 10 & 13 & 15 & 14 & 32 & 11 & 18 & --\\
\end{tabular}%
}
...
arm}: over the full-range lensed configuration the control returns $1.16$ in $\chi^{2}$ per bin and this arm $2.98$, the arm at $2.57$ times the control's distance from the data; refitting both arms' own parameters leaves it at $1.45$ times, and moves this arm's expansion rate and matter density by a hundredth and two tenths of a per cent from where the baryon-acoustic distances put them~\cite{JanzenCRcosmology}. \emph{The construction's acoustic spectrum is rejected on TT shape}, and what remains is an acoustic phase residual of $2.3\%$ and a fourth peak $0.9\%$ high, the comb itself
