...
actual smeared bracket — the term-for-term smeared homomorphism at the symmetric cut. **Remaining conjecture:**
...
distinct further source. **Remaining conjecture:** the genuine matter mode level ($m'\neq0$); the non-isometry
...
limit $m=M$ recovers step 5. **Scope conjecture:** the component structure (mass$\to$angular,
...
connection**, not a closure failure. **Still open conjecture:** full closure across $\mathcal{C}$ remains pinned
