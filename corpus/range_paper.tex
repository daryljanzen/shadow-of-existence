...
cuts should be of a type that admits such a form at all---is answered in \S\ref{sec:pd} by a different argument,
and the two join. The substrate's null rulings are shear-free; a cut that inherits one as its principal
...
constant of motion that tensor carries is Carter's\rcpt{V1_carter_chain}. \emph{So the explanation does not
