...
inner horizon is open---the complement of the reducible sector on the \emph{vantage} axis, as the wall (\S\ref{sec:wall}) is its complement where continuous \emph{symmetry} is lost, both handed to the same matter frontier~\cite{JanzenCRframework}.
