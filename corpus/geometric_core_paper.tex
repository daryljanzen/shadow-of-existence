...
\emph{Whether the area law carries is settled per member rather than once}, and the two horizons this
corpus uses fall on opposite sides. At the substrate's own horizon the Noether-charge construction has its
...
sharper statement, and it is why this question looked undecidable while being asked of two objects at once. \emph{Were it to fail to carry, that
