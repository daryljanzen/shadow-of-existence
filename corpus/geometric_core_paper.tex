...
mass, geometric or fermionic, is the substrate's one $R$-odd datum. One
...
all, and the programme calls it a one-parameter accommodation. What is owed
there is its derivation from the progenitor collapse, not a further audit of the
ledger.
