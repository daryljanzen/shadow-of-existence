...
That circle is the incircle of the hinge triangle and its nine-point circle besides, so the hinges stand at $2\alpha$ as an \emph{output} of the hole rather than a stipulation, the three sides are the Nariai double null rulings tangent at their midpoints, and the triple-angle identity returns the Nariai configuration of its own accord~\cite{JanzenSlicing}. 
