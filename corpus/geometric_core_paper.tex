...
freezes like every mode, and so does not carry a phase by failing to freeze.
\end{remark}
...
$\hbar$ enters only at the de~Sitter cosmological horizon, scaled by $\Lambda$ alone, the
...
unification is held as a conjecture rather than an established result. Reciprocal, and it fixes the \emph{altitude} of
...
$\omega/|aH|\to0$ independent of $m$---a massive trajectory freezes like every mode, and does not carry a
phase by failing to freeze\rcpt{S1_a_massive_mode_freezes_too_and_the_mass_term_vanishes_at_the_branch_point}.
