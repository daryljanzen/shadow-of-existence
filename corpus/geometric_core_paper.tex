...
for a homogeneous space the action algebroid of $G$ on $G/H$ \emph{is} the Atiyah algebroid of
...
These are the two real forms of the one complex group $SO(6,\mathbb{C})$, meeting at the horizon where $\beta=2\pi\alpha$. 
