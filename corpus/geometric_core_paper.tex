...
%  REGISTER ALIAS: the maximal-symmetry ledger -- register `PO-18`, OPEN and narrower than stated
...
%  REGISTER ALIAS: the phase structure at the seam -- register `PO-17`, OPEN and held do-not-assert
%  in both directions.
%  This list stays in the paper's own voice; the alias lives in a comment so a reader meets
%  the physics and a node can still trace what is owed.  Unregistered before r2378.
\end{enumerate}
