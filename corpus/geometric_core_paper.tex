...
The two-way landing map below is complete across all sixteen rounds. The paper is opened so that the
...
both ways; the one-circle edge drawn.} Forward: P3's substrate-and-cut section now carries the
...
both ways; the one-circle edge drawn.} Forward: P14 points here, reading its three chiral
...
opened. This is the programme of the paper, stated so it can be reversed.
