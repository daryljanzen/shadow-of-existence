...
acoustic scale. \emph{What is left of this item is not a spacing deficit but an acoustic phase}, and the
paragraphs at the end of \S\ref{sec:refit-bound} give it. \emph{That is a
...
$\phi/\pi$---and the control's $0.263$ lies inside that span.} A quantity the datum can move across the value
it is being compared against is not a prediction of the construction. \emph{The attribution to the driving
stands}---the driving is what separates the two arms at any given reading---\emph{but its promotion to ``the
whole disagreement'' does not.}

\emph{And the peak heights move with the same freedom, and do not reach the sky either.} The ratio of the
first peak to the second runs from $0.48$ to $1.62$ across the four, against $2.22$ in the sky and $2.20$ in
the control. \emph{What is left robust is the spacing}: $0.963$ to $0.981$ of $\ell_{A}$ over the same four
...
freedom on the same bins---$224$ against $3.71$. \emph{Agreeing on the phase does not fix the spectrum}, so
