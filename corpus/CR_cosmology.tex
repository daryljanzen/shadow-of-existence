...
There the control returns a first-to-second height ratio of $2.196$ at peaks $220$, $540$ and $812$, against
...
control's own movement between cutoffs is $0.042\%$ and $0.036\%$ on the two height ratios, and this
cosmology's arm moves by no more than the control does---$0.00\%$ and $0.045\%$---so the arm is converged at
the lower cutoff and the figures below are not a truncation artefact. \emph{A rung below that was refused
...
The peaks fall at $204$, $524$, $828$ and $1196$, with $\ell_{1}/\ell_{A}=0.6764$ against the sky's $0.7312$
---\emph{a deficit of $7.5\%$ in position}---and height ratios $P_{1}/P_{2}=1.759$ and $P_{1}/P_{3}=1.612$
...
arm's first peak from $204$ to $340$, and $\ell_{1}/\ell_{A}$ from $0.6764$ to $1.1273$: \emph{the modes
carrying the first peak are driven, and by $136$ multipoles' worth}\rcpt{P15_the_phase_is_the_driving_and_the_undriven_arms_agree}. \emph{What that leaves is a measured
