...
\emph{What fixes this rate is worth stating before what it recovers.} The rate this cosmology computes on is set by the substrate's geometry and by nothing else. Its two parameters are the substrate curvature radius $\alpha=\sqrt{3/\Lambda}$---an invariant length---and the offset $x_{0}$ of the cut, and neither is a content of the universe:
