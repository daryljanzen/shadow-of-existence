...
result to read in the upper panels; \emph{the residuals are where the rejection lives}, and three quarters of
this arm's is the control's.}\label{fig:acoustic}
\end{figure}
...
this arm's leaves $73\%$ of it shared --- stable across three bin cuts. \emph{So three quarters of the
disagreement is the transfer's and not the construction's.} \emph{And what remains is position rather than
