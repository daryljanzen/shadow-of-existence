...
was read that way once.} Continuing the closed form onto the leaf rate is a closed form applied to a rate it
...
the two per cent is not an artefact of the rate}: it stands, and wants a mechanism.
