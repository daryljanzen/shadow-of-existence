...
\subsection{Where the acoustic modes stand at the onset depends on the rate, and the branch point is the opposite}
...
distinction is load-bearing}\rcpt{P15_the_locus_is_wrong_in_six_places_and_the_lint_cannot_see_the_worst}. $z_{\mathrm{onset}}$ is a redshift on the
...
concerns the onset and nothing else}, and its answer there is the one the rate rule selects: read on the leaf
congruence the acoustic band below $\ell=237.7$ is still super-horizon when the plasma comes into being, and
the band $155.6<\ell<237.7$ enters while radiation dominates. \emph{The inside-the-horizon reading is the
stacking rate's}, and the two onset redshifts quoted above---$6797$ and $6761$---are that same pair of rates
read at the same event, not two values of one quantity.
