...
$2.10$ per bin rather than unity because the multipole ceiling cuts the damping tail on an unlensed spectrum;
\emph{that is a factor of two, and this arm is fifty-six times the control}. \emph{So the shortfall is not
the configuration}: it is the $6.6\%$ position deficit and the height ratios of \S\ref{sec:refit-bound},
carried across every bin.
