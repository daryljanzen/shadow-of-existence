...
\emph{And neither residual is a background choice.} Under the refit the acoustic phase goes from $2.3\%$ to
$3.4\%$ out---\emph{worse}, the fit trading it for likelihood elsewhere, against the control's $1.6\%$---and
the fourth peak's excess is unmoved. \emph{So both are properties of the construction rather than of the background it is
computed on}, which is what a refit is for.
