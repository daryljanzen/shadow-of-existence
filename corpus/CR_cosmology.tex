...
monopole and the Doppler terms of the source, bracketed with opposite signs by removing each, and no
mechanism for the imbalance is offered here.
...
The exposed edges lie elsewhere---the acoustic phase residual of the first item and the damping signature it carries;
