...
numerical accident of $z_{\mathrm{onset}}$, and a statement about the seam that Prop.~\ref{prop:subhorizon}, being about the onset, does not make\rcpt{C2_horizon_limits}. \emph{The locus matters and the two
