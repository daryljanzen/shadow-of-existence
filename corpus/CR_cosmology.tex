...
establishing that they do. \emph{What produces that pattern is not settled here}: the driving is measured on
both arms and this one is driven $2.4$ times as hard, and whether that is a second physical dose on the
expanding leg or one decay counted twice turns on which potential the transfer starts that leg with ---
\emph{a question this paper does not answer}.
