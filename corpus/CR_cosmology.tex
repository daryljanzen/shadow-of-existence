...
paths, so what remains is the phase intercept, $2.3\%$ out, and the fourth peak.
...
datum through to recombination is the transfer of \S\ref{sec:refit-bound}, which is run and returns the deficit recorded there. They are, rather, the map of where this cosmology goes next---a mechanism for that deficit and the full oscillating medium downstream in the matter sector, the tensor sector's companion in the dynamics paper~\cite{JanzenDynamics}.
