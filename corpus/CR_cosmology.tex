...
carrying the first peak are driven, and by $136$ multipoles' worth}\rcpt{P15_the_phase_is_the_driving_and_the_undriven_arms_agree}.
\emph{Run on the control the same subtraction moves $276$ to $220$, a shift of $0.1858$ in
$\ell_{1}/\ell_{A}$ against this arm's $0.4509$}---so the arm is not driven less than the control but
...
control's undriven position to below the control's driven one, past the sky. (Both subtractions are taken on
the fluid path at the lower cutoff, where the two are measured against each other on one path.)
