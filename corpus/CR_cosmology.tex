...
\item the progenitor spectrum itself---$n_s$ and $A_s$ (\S\ref{sec:transmission})---inherited boundary data fixed by the progenitor collapse, the baryogenesis-analogue computation belonging to the matter sector~\cite{JanzenOperator,JanzenRange}, with the honest target a consistency between the inherited composition and spectrum and the measured primordial abundances and tilt, not a derivation from the geometry alone---the most ambitious reach of the four, the one that would close the decomposition from both ends and give CR a derivation where the standard model keeps a measured datum. \emph{One route to it is closed, and closing it narrows the
