...
We mark maturity throughout. \emph{Established}: the cosmological derivation, the transmission dichotomy, the amplitude floor, the throat, the flat slice, the flat-projection transfer, the data confrontation, and the time-reversal driving equality as a Fourier theorem. \emph{Argued}: the coherence mechanism. \emph{Measured}: the peak \emph{heights}, which this arm's own instrument returns $20.7\%$ and $29.2\%$ below the sky's first two ratios, so the driving equality is not shown to carry them. 
