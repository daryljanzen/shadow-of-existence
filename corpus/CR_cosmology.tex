...
signature almost entirely in shape}, leaving $0.26$ in $\chi^{2}$ per bin over the $185$-bin ceiling and less the higher one
looks. \emph{But the absorption is bought, not free}: it costs a shift of $-0.0304$ in the inferred tilt
against a $\sigma$ of $0.00323$ derived from the same covariance that scores the fit. \emph{So the signature
...
\emph{And the displacement is not one number}: fitted over $\ell=100$--$1760$ it is $-0.083$, over
$\ell=1400$--$2508$ it is $-0.521$ --- a factor of $6.3$ across windows of the same data, so a
