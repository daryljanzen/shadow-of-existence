...
and read the agreement as a corroboration; that reading is withdrawn.} \emph{On the current integrals that pinning returns $6844$ against the $6850$ in use---agreement to
$0.09\%$.} The rounded target sits $0.25\%$ from the
