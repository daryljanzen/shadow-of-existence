...
\begin{description}
\item[\rcptlabel{P12_bracket_closure}{P12R1}\textbf{P12R1}\quad\texttt{P12\_bracket\_closure}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{P12_coset_metric}{P12R2}\textbf{P12R2}\quad\texttt{P12\_coset\_metric}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{E1_static_gauge}{P12R3}\textbf{P12R3}\quad\texttt{E1\_static\_gauge}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{EMBEDDING_is_Td_equals_WA3}{P12R4}\textbf{P12R4}\quad\texttt{EMBEDDING\_is\_Td\_equals\_WA3}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{GROUP_full_order48}{P12R5}\textbf{P12R5}\quad\texttt{GROUP\_full\_order48}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{K8_orbit_type_filtration}{P12R6}\textbf{P12R6}\quad\texttt{K8\_orbit\_type\_filtration}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{K8b_dim_seven_empty}{P12R7}\textbf{P12R7}\quad\texttt{K8b\_dim\_seven\_empty}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{I13_the_stratification_is_a_ledger_of_first_integrals}{P12R8}\textbf{P12R8}\quad\texttt{I13\_the\_stratification\_is\_a\_ledger\_of\_first\_integrals}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{P12_polar_dimension}{P12R9}\textbf{P12R9}\quad\texttt{P12\_polar\_dimension}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{P12_the_separator_must_carry_the_mass}{P12R10}\textbf{P12R10}\quad\texttt{P12\_the\_separator\_must\_carry\_the\_mass}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:M3_station_G_supplies_the_sequence_and_the_three_are_one_knot}\textbf{}\quad\texttt{M3\_station\_G\_supplies\_the\_sequence\_and\_the\_three\_are\_one\_knot}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:N1_the_cut_being_four_is_what_makes_the_dynamics_forced}\textbf{}\quad\texttt{N1\_the\_cut\_being\_four\_is\_what\_makes\_the\_dynamics\_forced}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:V1_the_variational_ledgers_premise_is_false}\textbf{}\quad\texttt{V1\_the\_variational\_ledgers\_premise\_is\_false}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:S1_seven_necessary_conditions_on_the_measure}\textbf{}\quad\texttt{S1\_seven\_necessary\_conditions\_on\_the\_measure}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:E50_a_second_step_is_emptied_by_rule_two_and_not_forbidden_by_it}\textbf{}\quad\texttt{E50\_a\_second\_step\_is\_emptied\_by\_rule\_two\_and\_not\_forbidden\_by\_it}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:C3_the_isotropy_citation_runs_in_a_loop}\textbf{}\quad\texttt{C3\_the\_isotropy\_citation\_runs\_in\_a\_loop}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{A1_the_triple_is_an_algebra_fact}{P12R11}\textbf{P12R11}\quad\texttt{A1\_the\_triple\_is\_an\_algebra\_fact}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{A3_the_convergence_audit}{P12R16}\textbf{P12R16}\quad\texttt{A3\_the\_convergence\_audit}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:A1_the_atiyah_sequence_is_not_missing_from_P12_it_is_P12s_object_unnamed}\textbf{}\quad\texttt{A1\_the\_atiyah\_sequence\_is\_not\_missing\_from\_P12\_it\_is\_P12s\_object\_unnamed}]\hfill\textsf{[OK]}\\
...
\item[\rcptlabel{I55_the_atiyah_sequence_is_exact_and_a_characteristic_class_is_not_available}{P12R18}\textbf{P12R18}\quad\texttt{I55\_the\_atiyah\_sequence\_is\_exact\_and\_a\_characteristic\_class\_is\_not\_available}]\hfill\textsf{[OK]}\\
