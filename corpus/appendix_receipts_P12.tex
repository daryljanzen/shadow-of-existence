...
\begin{description}
\item[\label{rcpt:P12_bracket_closure}\textbf{P12R1}\quad\texttt{P12\_bracket\_closure}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P12_coset_metric}\textbf{P12R2}\quad\texttt{P12\_coset\_metric}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:E1_static_gauge}\textbf{P12R3}\quad\texttt{E1\_static\_gauge}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:EMBEDDING_is_Td_equals_WA3}\textbf{P12R4}\quad\texttt{EMBEDDING\_is\_Td\_equals\_WA3}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:GROUP_full_order48}\textbf{P12R5}\quad\texttt{GROUP\_full\_order48}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:K8_orbit_type_filtration}\textbf{P12R6}\quad\texttt{K8\_orbit\_type\_filtration}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:K8b_dim_seven_empty}\textbf{P12R7}\quad\texttt{K8b\_dim\_seven\_empty}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:I13_the_stratification_is_a_ledger_of_first_integrals}\textbf{P12R8}\quad\texttt{I13\_the\_stratification\_is\_a\_ledger\_of\_first\_integrals}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P12_polar_dimension}\textbf{P12R9}\quad\texttt{P12\_polar\_dimension}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P12_the_separator_must_carry_the_mass}\textbf{P12R10}\quad\texttt{P12\_the\_separator\_must\_carry\_the\_mass}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:A1_the_triple_is_an_algebra_fact}\textbf{P12R11}\quad\texttt{A1\_the\_triple\_is\_an\_algebra\_fact}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:A3_the_convergence_audit}\textbf{P12R16}\quad\texttt{A3\_the\_convergence\_audit}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:I55_the_atiyah_sequence_is_exact_and_a_characteristic_class_is_not_available}\textbf{P12R18}\quad\texttt{I55\_the\_atiyah\_sequence\_is\_exact\_and\_a\_characteristic\_class\_is\_not\_available}]\hfill\textsf{[OK]}\\
