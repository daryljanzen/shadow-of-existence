...
\emph{The physics was never in question and the pointer was}---a sentence whose whole point is that these are not read off a correspondence should not appear to quote a reference column.
