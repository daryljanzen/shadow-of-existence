...
%   inheritance -- the corrected reading). Forced at rule-favoured altitude; the open
...
horizon and re-manufactures the Hubble tension the geometric rate
...
against at the acoustic peaks. The falsifiable demand beyond the anchors---whether \emph{one}
progenitor handover, one value of the inherited datum, fits deuterium, helium-4 and helium-3
\emph{together}---is met at the level this paper's network reaches: the multi-abundance pattern comes out jointly from the single
