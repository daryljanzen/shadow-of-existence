...
paper, P17/17~\cite{JanzenGeometricCore})---while
...
carries the network's computed $0.2432$ to $0.2471$\rcpt{P16_validate_bbn}. \emph{The standalone weak-freeze-out receipt returns $0.2506$ on a Born-level two-species network, agreeing with the standard value from the other side; the figure quoted here is the network's.} it is set by the neutron lifetime~\cite{PDG2022} and $\eta$, not the
