...
heat-kernel coefficients as its instrument. The propagating sector itself is a clean, unitary, deparametrized evolution---a true Hamiltonian generating the graviton on the layer, in cosmic time.
