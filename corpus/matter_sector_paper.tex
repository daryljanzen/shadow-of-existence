...
%   STRUCTURE FIXES": the Weyl S_3 is the monodromy symmetry of the solution space and NO substrate
...
remain unclaimed. The factorisation the boundary paper states is thereby realised on the sector it bounds, at exactly its earned weight, and no further: coherence within CR, the world-correspondence the data's to judge.
