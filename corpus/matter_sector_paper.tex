...
\emph{And the shape is tested against the observed spectrum rather than left as a shape.}  Taking the condition at face value---a configuration exists only if its total residue
