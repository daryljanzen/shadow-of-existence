...
\item[\label{ldg:cartan_holonomy}\textbf{L3}\quad\texttt{CARTAN\_HOLONOMY\_LEDGER.md}]\hfill\textsf{[field bake]}\\
...
\item[\label{ldg:category_theory}\textbf{L5}\quad\texttt{CATEGORY\_THEORY\_LEDGER.md}]\hfill\textsf{[field bake]}\\
...
\item[\label{ldg:complex_analysis}\textbf{L7}\quad\texttt{COMPLEX\_ANALYSIS\_LEDGER.md}]\hfill\textsf{[field bake]}\\
complex analysis and monodromy against CR --- the field that turned practices into theorems
\item[\label{ldg:conformal_geometry}\textbf{L8}\quad\texttt{CONFORMAL\_GEOMETRY\_LEDGER.md}]\hfill\textsf{[field bake]}\\
conformal / M\"obius geometry against the substrate --- the field that refused, and why
\item[\label{ldg:convexity_optimisation}\textbf{L9}\quad\texttt{CONVEXITY\_OPTIMISATION\_LEDGER.md}]\hfill\textsf{[field bake]}\\
...
\item[\label{ldg:involution_real_forms}\textbf{L15}\quad\texttt{INVOLUTION\_REAL\_FORMS\_LEDGER.md}]\hfill\textsf{[field bake]}\\
...
\item[\label{ldg:variational}\textbf{L20}\quad\texttt{VARIATIONAL\_LEDGER.md}]\hfill\textsf{[field bake]}\\
variational / action against CR --- the field the corpus uses and never names
\item[\label{ldg:graph_theory}\textbf{L11}\quad\texttt{GRAPH\_THEORY\_LEDGER.md}]\hfill\textsf{[field bake]}\\
...
\item[\label{ldg:numerical_analysis}\textbf{L22}\quad\texttt{NUMERICAL\_ANALYSIS\_LEDGER.md}]\hfill\textsf{[field bake]}\\
...
\item[\label{ldg:index_theory}\textbf{L13}\quad\texttt{INDEX\_THEORY\_LEDGER.md}]\hfill\textsf{[field bake]}\\
The differential-topology and index-theory field-bake ledger --- what bit, what bounced, and where the boundary is
\item[\label{ldg:integrable_systems}\textbf{L14}\quad\texttt{INTEGRABLE\_SYSTEMS\_LEDGER.md}]\hfill\textsf{[field bake]}\\
