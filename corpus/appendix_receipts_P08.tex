...
\begin{description}
\item[\label{rcpt:P08_matter_functional}\textbf{P8R1}\quad\texttt{P08\_matter\_functional}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_lapse_split}\textbf{P8R2}\quad\texttt{P08\_lapse\_split}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_E1_cosmology}\textbf{P8R3}\quad\texttt{P08\_E1\_cosmology}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_nariai_signed_roots}\textbf{P8R4}\quad\texttt{P08\_nariai\_signed\_roots}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_trichotomy}\textbf{P8R5}\quad\texttt{P08\_trichotomy}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_synchronous_horosphere}\textbf{P8R6}\quad\texttt{P08\_synchronous\_horosphere}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_the_second_ruling_reading_does_not_extend_to_the_collapse_face}\textbf{P8R7}\quad\texttt{P08\_the\_second\_ruling\_reading\_does\_not\_extend\_to\_the\_collapse\_face}]\hfill\textsf{[ALL PASS]}\\
...
\item[\label{rcpt:P08_the_closure_is_the_constitutive_relation}\textbf{P8R8}\quad\texttt{P08\_the\_closure\_is\_the\_constitutive\_relation}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:K6_fullness}\textbf{P8R9}\quad\texttt{K6\_fullness}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:K9_isotropy_obstruction}\textbf{P8R10}\quad\texttt{K9\_isotropy\_obstruction}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:V34_orthogonal_and_no_cost}\textbf{P8R11}\quad\texttt{V34\_orthogonal\_and\_no\_cost}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:P08_the_branch_point_monodromy_is_Z3}\textbf{P8R12}\quad\texttt{P08\_the\_branch\_point\_monodromy\_is\_Z3}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:I12_the_marginal_member_is_the_only_non_degenerate_one_that_integrates}\textbf{P8R13}\quad\texttt{I12\_the\_marginal\_member\_is\_the\_only\_non\_degenerate\_one\_that\_integrates}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:order3_bridge}\textbf{P7R6}\quad\texttt{order3\_bridge}]\hfill\textsf{[OK]}\\
...
\item[\label{rcpt:I52_the_vacuum_theorem_is_an_index_one_statement_and_the_index_is_the_mass}\textbf{P8R14}\quad\texttt{I52\_the\_vacuum\_theorem\_is\_an\_index\_one\_statement\_and\_the\_index\_is\_the\_mass}]\hfill\textsf{[OK]}\\
