...
\subsection{The substrate is a real manifold, and its signature is intrinsic}
...
imaginary fifth coordinate is a property of one embedding picture, not of the surface.
...
\emph{Finite curvature is sufficient but not necessary} for a boundary to be crossed. The corpus's own
continuation runs through a locus at which the areal chart's invariants diverge, and it runs through it
because the substrate is smooth there, not because the chart is~\cite{JanzenCircle,JanzenSlicing}.
