...
this diagnostic is stated on, and what is open there is whether a charged \emph{collapse} forms the
inner horizon at all---the eternal solution carries one, but if a dynamical collapse does not, the
branch point survives and the case rejoins the uncharged bead~\cite{JanzenCRframework}.
