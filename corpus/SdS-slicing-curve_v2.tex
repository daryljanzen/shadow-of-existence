...
$Q$. \emph{What is open is whether a charged \emph{collapse} reaches that stationary structure at all.}
The function above is the eternal Reissner--Nordstr\"om--de~Sitter geometry; a collapse is a dynamical
one, and if it does not form the Cauchy horizon then the branch point survives and the charged case
rejoins the uncharged loop of \S\ref{sec:lap}. That question is the framework paper's, whose bead this
loop is~\cite{JanzenCRframework}, and it is not settled here.
