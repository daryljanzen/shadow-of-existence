...
paper's~\cite{JanzenCanonicalTime}. The bend crossing the cosmogenesis branch point is well posed on
the finite-curvature branch point $r=0$ and structurally governed~\cite{JanzenCRframework}, with the
